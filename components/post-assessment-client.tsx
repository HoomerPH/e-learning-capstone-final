...
import { getPostAssessmentQuestions } from "@/lib/assessments";
...
export function PostAssessmentClient({ courseId, courseTitle }: PostAssessmentClientProps) {
  const questions = getPostAssessmentQuestions(courseId);
  ...
  return (
    <div className="container max-w-4xl mx-auto py-12">
      ...
      <Card className="p-8">
        <div className="mb-8">
          <h1 className="text-2xl font-bold mb-2">Post-Assessment</h1>
          <p className="text-muted-foreground">
            {courseTitle}
          </p>
        </div>
